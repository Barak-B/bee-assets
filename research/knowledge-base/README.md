...
| `il-self-employed-tax.md` | מע"מ, מקדמות מס הכנסה, ביטוח לאומי לעצמאי | `[OPEN]` — research queued |
...
5. `[OPEN]` מע"מ לעצמאי + מקדמות + דיווח דו-חודשי — לוחות זמנים שייכנסו ל-alfred-deadlines.js
